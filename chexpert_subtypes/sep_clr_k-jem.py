...
from data_augmentation import ChestXRayDataAugmentation
from dataset import get_chest_xrays_datasets
...
train_dataset, test_dataset = get_chest_xrays_datasets()
train_loader = torch.utils.data.DataLoader(dataset=train_dataset, batch_size=batch_size, shuffle=True, drop_last=True)
test_loader = torch.utils.data.DataLoader(dataset=test_dataset, batch_size=batch_size)

# instantiate Data Augmentation pipeline
data_aug_pipeline = ChestXRayDataAugmentation()
...
torch.save(encoder, "chexpert_k-jem_sep_clr.pth")
