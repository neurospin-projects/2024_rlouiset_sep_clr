...
class CelebADataAugmentation(nn.Module):
    """Module to perform data augmentation for CelebA using Kornia on torch tensors."""
    ...
    def __init__(self) -> None:
        ...
        self.transforms = nn.Sequential(
            RandomResizedCrop((128, 128), scale=(0.2, 1)),
